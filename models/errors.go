...
const (
	...
	ErrSubjectRequired modelError = "models: Subject is required"

	ErrSerialNoRequired modelError = "models: Serial Number is required"

	ErrAdminRequired modelError = "models: Only admins can access this page"
